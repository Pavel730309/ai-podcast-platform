"""
KIE.ai provider for scenario generation
"""
import json
...
class KIEProvider(BaseAIProvider):
    """KIE.ai GPT provider for scenario generation"""
...
{{
    ...
    async def generate_scenario(
        ...
        """Generate podcast scenario using KIE.ai"""
        ...
        try:
            ...
            return ScenarioResult(
                ...
                total_lines=0,
                estimated_duration_minutes=0,
                error=f"Failed to parse KIE.ai response: {str(e)}"
            )
